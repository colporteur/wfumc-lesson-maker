    ...
    return (
      <div className="max-w-lg mx-auto mt-12 p-6 text-center space-y-4">
        ...
        <p className="text-gray-600 text-sm">
          ...
          This usually clears up with a reload — the profile briefly
          didn't come back from the server. If reloading doesn't work,
          ask Pastor Todd to confirm your account.
        </p>
        <button
          type="button"
